...
import AppWebSite from '../components/website/AppLayout'
      ...
      children: [
        {
          name: '/',
          path: '/',
          component: lazyLoading('website/pages/Content'),
          default: true,
        },
        {
          name: 'about',
          path: 'about',
          component: lazyLoading('website/pages/About'),
          default: true,
        },
        {
          name: 'properties',
          path: 'properties',
          component: lazyLoading('website/pages/Properties'),
          default: true,
        },
        {
          name: 'contact',
          path: 'contact',
          component: lazyLoading('website/pages/Contact'),
          default: true,
        },
